...
function App() {
  const doChatStream = async function () {
    ...
    try {
      ...
      // Ajoutez un diviseur ou un espace avant d'afficher la nouvelle réponse
      document.getElementById("output").innerHTML += "<hr style='margin-top: 20px; margin-bottom: 20px;'/>";
